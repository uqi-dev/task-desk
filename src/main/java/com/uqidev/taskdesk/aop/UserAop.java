package com.uqidev.taskdesk.aop;
...
public class UserAop {
    ...
    @Before(value = "execution(* com.uqidev.taskdesk.service.UserService.createUser()) && args(name)")
    public void beforeUserCreate(JoinPoint joinPoint, String name) {
        System.out.println("Before method:" + joinPoint.getSignature());
        System.out.println("Creating user with name: " + name);
    }

    @After(value = "execution(* com.uqidev.taskdesk.service.UserService.createUser()) && args(name)")
